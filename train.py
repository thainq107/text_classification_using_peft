...
from model.model import load_model, prepare_lora_model, prepare_prefix_model, prepare_prompt_model
...
def train(model_args, data_args, training_args, peft_args):
    # Setup logging
    logging.basicConfig(
    ...
    if peft_args.use_lora:
        model = prepare_lora_model(peft_args, model)
        model.print_trainable_parameters()
    
    elif peft_args.use_prefix:
        model = prepare_prefix_model(peft_args, model)
        model.print_trainable_parameters()
    
    elif peft_args.use_prompt:
        model =  prepare_prompt_model(peft_args, model)
        model.print_trainable_parameters()
